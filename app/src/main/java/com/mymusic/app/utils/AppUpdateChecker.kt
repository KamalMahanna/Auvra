...
class AppUpdateChecker @Inject constructor(
    ...
    suspend fun checkForUpdate(force: Boolean = false): AppRelease? = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            val htmlUrl = json.optString("html_url", "https://github.com/KamalMahanna/MyMusic/releases")
    ...
    companion object {
        ...
        private const val PREFS_NAME = "mymusic_update_prefs"
        private const val KEY_DISMISSED_TAG = "dismissed_release_tag"
        private const val GITHUB_LATEST_RELEASE_URL =
            "https://api.github.com/repos/KamalMahanna/MyMusic/releases/latest"
